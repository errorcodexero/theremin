...
Step::Status Vision_drive::done(Next_mode_info){
	return timeout_timer.done() ? Step::Status::FINISHED_SUCCESS : Step::Status::UNFINISHED;	
}
...
bool Vision_drive::operator==(Vision_drive const& a)const{
	return timeout_timer == a.timeout_timer;
}
